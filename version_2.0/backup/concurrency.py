...
## https://www.educative.io/courses/python-concurrency-for-senior-engineering-interviews/gkVzyO8V6Qj
...
def producer_thread(q, val):
    item = val
    while 1:
        print("\n{0} producing item {1}".format(current_thread().getName(), item), flush=True)
        q.enqueue(item)
        item += 1
        time.sleep(0.1)
